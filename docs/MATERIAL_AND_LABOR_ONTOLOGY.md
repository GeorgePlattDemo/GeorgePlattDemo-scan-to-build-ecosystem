...
**Companion documents:** `docs/ARCHITECTURE.md` (system architecture, v2), `packages/schema/workPacket.ts`
...
TypeScript-style definitions (authoritative source: `packages/schema/workPacket.ts`; abbreviated here for review).
